...
import styles from './PaginationEnmiendasTable.module.css'
...
export default function PaginationEnmiendasTable(props: PaginationTableProps) {
...
PaginationEnmiendasTable.defaultProps = {
	noAddButton: false,
	addButtonIcon: 'add',
